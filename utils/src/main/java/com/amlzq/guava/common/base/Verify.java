...
public final class Verify {
  ...
  public static void verify(
    ...
    if (!expression) {
      throw new VerifyException(Preconditions.format(errorMessageTemplate, p1));
    }
  }
  ...
  public static void verify(
    ...
    if (!expression) {
      throw new VerifyException(Preconditions.format(errorMessageTemplate, p1, p2));
    }
  }
  ...
  public static void verify(
    ...
    if (!expression) {
      throw new VerifyException(Preconditions.format(errorMessageTemplate, p1, p2, p3));
    }
  }
  ...
  public static void verify(
    ...
    if (!expression) {
      throw new VerifyException(Preconditions.format(errorMessageTemplate, p1, p2, p3, p4));
    }
  }
